...
cards.show(pHolder, "MouthQuiz");
      ...
      class esophogousPanel extends JPanel implements MouseListener, KeyListener//esophogous panel that user moves food around to get digested. Uses key listner and bufferedimage
      //   //also tied in with esophogousQuiz to ask questions regarding the class
      {
        // private BufferedImage donutm;
        // private BufferedImage sodam;
        // private BufferedImage oatmealm;
        ...
        public esophogousPanel()
        {
          ...
          System.out.println("esophogousPanel reached");
          addMouseListener(this);
          addKeyListener(this);//adds KeyListener
          run();
        }//end of esophogousconstructor
        ...
        public void getMyImage()//gets image for use
        {
          ...
          {
            System.err.println("\n\n"+esophogousBackgroundName+"can't be found. \n\n");
            System.out.println("catched esophogousBackground");
            System.err.println("\n\n"+donutName+"can't be found. \n\n");
            System.out.println("catched donut");
            System.err.println("\n\n"+oatmealName+"can't be found. \n\n");
            System.out.println("catched oatmeal");
      ...
      //Click anywhere on the screen to being after clicking OK to this message!
        ...
        if(oatmealY>700&&oatmealY<750&&oatmealX>600&&oatmealX<650)
        {
      cards.show(pHolder, "esophogousQuiz");
        if(sodaY>700&&sodaY<750&&sodaX>600&&sodaX<650)
        {
      cards.show(pHolder, "esophogousQuiz");
        }
      ...
      }//end of esophogous panel


      class esophogousQuestions extends JPanel implements ActionListener
      {
      ...
      }//end of esophogous questions

      class stomachPanel extends JPanel implements MouseListener, KeyListener//stomach panel that user moves food around to get digested. Uses key listner and bufferedimage
      //   //also tied in with stomachQuiz to ask questions regarding the class
      {
        // private BufferedImage donutm;
        // private BufferedImage sodam;
        // private BufferedImage oatmealm;
        ...
        public stomachPanel()
        {
          ...
          System.out.println("stomachPanel reached");
          addMouseListener(this);
          addKeyListener(this);//adds KeyListener
          run();
        }//end of stomachconstructor
        ...
        public void getMyImage()//gets image for use
        {
          ...
          {
            System.err.println("\n\n"+stomachBackgroundName+"can't be found. \n\n");
            System.out.println("catched stomachBackground");
            System.err.println("\n\n"+donutName+"can't be found. \n\n");
            System.out.println("catched donut");
            System.err.println("\n\n"+oatmealName+"can't be found. \n\n");
            System.out.println("catched oatmeal");
      ...
      public void paintComponent(Graphics g)
      {
        super.paintComponent(g);
        //Graphics2D g = donutm.createGraphics();    // Get a Graphics2D object
        g.drawImage(stomachBackground,0,0,800,800,this);
        // JOptionPane.showMessageDialog (null, "Instructions", "Click anywhere on the screen to being after clicking OK to this message!", JOptionPane.INFORMATION_MESSAGE);
      ...
      //Click anywhere on the screen to being after clicking OK to this message!
        ...
        if(oatmealY>700&&oatmealY<750&&oatmealX>600&&oatmealX<650)
        {
      cards.show(pHolder, "stomachQuiz");
        if(sodaY>700&&sodaY<750&&sodaX>600&&sodaX<650)
        {
      cards.show(pHolder, "stomachQuiz");
        }
      ...
      }//end of stomach panel


      class stomachQuestions extends JPanel implements ActionListener
      {
      ...
      }//end of stomach questions

      class smallIntestinePanel extends JPanel implements MouseListener, KeyListener//smallIntestine panel that user moves food around to get digested. Uses key listner and bufferedimage
      //   //also tied in with smallIntestineQuiz to ask questions regarding the class
      {
        // private BufferedImage donutm;
        // private BufferedImage sodam;
        // private BufferedImage oatmealm;
        ...
        public smallIntestinePanel()
        {
          ...
          System.out.println("smallIntestinePanel reached");
          addMouseListener(this);
          addKeyListener(this);//adds KeyListener
          run();
        }//end of smallIntestineconstructor
        ...
        public void getMyImage()//gets image for use
        {
          ...
          {
            System.err.println("\n\n"+smallIntestineBackgroundName+"can't be found. \n\n");
            System.out.println("catched smallIntestineBackground");
            System.err.println("\n\n"+donutName+"can't be found. \n\n");
            System.out.println("catched donut");
            System.err.println("\n\n"+oatmealName+"can't be found. \n\n");
            System.out.println("catched oatmeal");
      ...
      public void paintComponent(Graphics g)
      {
        super.paintComponent(g);
        //Graphics2D g = donutm.createGraphics();    // Get a Graphics2D object
        g.drawImage(smallIntestineBackground,0,0,800,800,this);
        // JOptionPane.showMessageDialog (null, "Instructions", "Click anywhere on the screen to being after clicking OK to this message!", JOptionPane.INFORMATION_MESSAGE);
      ...
      //Click anywhere on the screen to being after clicking OK to this message!
        ...
        if(oatmealY>700&&oatmealY<750&&oatmealX>600&&oatmealX<650)
        {
      cards.show(pHolder, "smallIntestineQuiz");
        if(sodaY>700&&sodaY<750&&sodaX>600&&sodaX<650)
        {
      cards.show(pHolder, "smallIntestineQuiz");
        }
      ...
      }//end of smallIntestine panel


      class smallIntestineQuestions extends JPanel implements ActionListener
      {
      ...
      public smallIntestineQuestions()
      {
      ...
      }//end of smallIntestine questions

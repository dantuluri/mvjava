...
public class SimpleLayout
{
	...
	public void makeFlowLayout()
	{
		...
		flowFrame.getContentPane().add(p1);
		flowFrame.getContentPane().add(p2);
		flowFrame.getContentPane().add(p3);
		flowFrame.getContentPane().add(p4);
		flowFrame.getContentPane().add(p5);
		flowFrame.getContentPane().add(p6);
